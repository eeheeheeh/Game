...
public class Player extends Entity {
    ...
    public void getPlayerImage() {
        try {
            ...
            down1 = ImageIO.read(getClass().getResourceAsStream("/player/frente1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/player/frente2.png"));
        ...
        if (i != 999) {
            ...
            switch (objectName) {
                ...
                case "Bread":
                    ...
                    gp.playSE(4);
                    gp.obj[i] = null;
                    gp.ui.showMessage("Tienes mas velocidad");
                    break;
                case "Chest":
